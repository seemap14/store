       ...
       <div class="col-md-12">
         <div class="cart-view-area">
           <div class="cart-view-table">
             <form action="add_to_cart.php?page_id=" method="POST">
                  ...
                  <table class="table">
                    ...
                    <?php if (isset($_SESSION["cart"])):?>
                      ...
                      <tr>
                        ...
                        <td>
                        <input class="aa-cart-quantity" name="new_qty[]" type="number" value="<?php echo $value2["qty"]?>">
                        <input type="hidden" name="id[]" value="<?php echo $value2["id"]?>"> </td>
                        <td><?php echo "$".($value2["qty"]*$value2["nprice"]);?></td>
                      </tr>
                    <?php endforeach;?>
                  <?php endforeach;?>
                <?php endif;?>
                      <tr>
                       <td colspan="6" class="aa-cart-view-bottom">
                         ...
                         <input class="aa-cart-view-btn" type="submit" name="update" value="Update Cart"></form>
                       </td>
                     </tr>
                      </tbody>
                  </table>
