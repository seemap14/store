<?php 
        ...
        $man=array();
        $c="men";
        $man=selectByCategory($c);

        $woman=array();
        $c="women";
        $woman=selectByCategory($c);

        $sport=array();
        $c="sports";
        $sport=selectByCategory($c);

         $electronics=array();
         $c="electronics";
         $electronics=selectByCategory($c);


        $kids=array();
        $c="kids";
        $kids=selectByCategory($c);    
?>
<!-- / menu -->
  <!-- Start slider -->
              ...
              <div class="aa-product-inner">
                <!-- start prduct navigation -->
                 ...
                 <?php foreach ($category as $key => $value):?>
                   <?php if($key==0){?>
                    <li class="active"><a href="<?php echo "#".$value['name']?>" data-toggle="tab"><?php echo $value['name']?></a>
                    </li>
                    <?php }
                    else
                    {
                      ?>
                    <li class=""><a href="<?php echo "#".$value['name']?>" data-toggle="tab"><?php echo $value['name']?></a>
                    </li>
                   <?php }?>
                    <?php endforeach;?>
                  ...
                  <div class="tab-content">
                      ...
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn" href="add_to_cart.php?id=<?php echo $value['id']?>&page_name=<?php echo $page?>"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              <figcaption>
                       ...
                       <a class="aa-browse-btn" href="product1.php?page_id=1">Browse all Product <span class="fa fa-long-arrow-right"></span></a>
                    </div>
                    ...
                    <div class="tab-pane fade" id="women">
                      <ul class="aa-product-catg">
                        <!-- start single product item -->
                        <?php foreach ($woman as $key => $value):?>
