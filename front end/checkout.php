                  ...
                  <div class="aa-order-summary-area">
                    <table class="table table-responsive">
                      ...
                      <?php foreach ($_SESSION["cart"] as $key => $value):?>
                        ...
                        <tr>
                          <td><?php echo $value1["name"]?> <strong> x <?php echo $value1["qty"]?> </strong></td>
                          <td><?php echo "$".($value1["nprice"]*$value1["qty"])?></td>
                        </tr>
                       <?php endforeach;?>
                       <?php endforeach;?>
                       <?php endif;?> 
                      ...
                      <tfoot>
                         ...
                         <tr>
                          <th>Total</th>
                          <td><?php if(isset($_SESSION["total_amount"]))echo "$".(35+$_SESSION["total_amount"])?></td>
                        </tr>
                      </tfoot>
                    </table>
                  </div>
