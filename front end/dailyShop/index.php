...
<?php include("config.php");
        ...
        $stmt->bind_param("s",$c);
        $stmt->bind_result($man_name,$man_nprice,$man_oprice,$man_img);
        $stmt->execute();
        while($stmt->fetch())
        {
          $man[]=array("name"=>$man_name,"nprice"=>$man_nprice,"oprice"=>$man_oprice,"img"=>$man_img);
        } 
        ...
        $stmt = $conn->prepare("SELECT name,new_price,old_price,img FROM New_Product where category=?");
        $stmt->bind_param("s",$c);
        $stmt->bind_result($woman_name,$woman_nprice,$woman_oprice,$woman_img);
        $stmt->execute();
        while($stmt->fetch())
        {
          $man[]=array("name"=>$woman_name,"nprice"=>$woman_nprice,"oprice"=>$woman_oprice,"img"=>$woman_img);
        }      
?>
<!-- / menu -->
  <!-- Start slider -->
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/man/<?php echo $value['img']?>" height="300px" width="220px" alt="polo shirt img"></a>
