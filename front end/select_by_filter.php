<?php 
        ...
        elseif(isset($_GET["lower"])&&isset($_GET["upper"]))
        {
        ...
        elseif(isset($_GET["cat_new"])){
          $data=array("cat_new"=>$_GET["cat_new"]);
        }
        else{
          $data=array();
        }
        
        $products=getAllProducts($upper,$lower,$data,$min,$max);
        $rec=getRecordsForFilters($upper,$lower,$data);
