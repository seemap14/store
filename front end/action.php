...
<?php 
        ...
        include("config.php");
        $stmt1=$conn->prepare("SELECT count(id) FROM New_Product WHERE category=?");
        ...
        $stmt->bind_result($pro_name,$pro_nprice,$pro_oprice,$pro_img);
        $stmt->execute();
        while($stmt->fetch())
        {
          $products_to_show[]=array("name"=>$pro_name,"nprice"=>$pro_nprice,"oprice"=>$pro_oprice,"img"=>$pro_img);
        } 
          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <?php foreach ($products_to_show as $key => $value):?>
              ...
              <nav>
                <ul class="pagination">
                  ...
                  /*for ($i=1; $i<=$records; $i++):
                      if($page_id==$i)
                      {
                        $pageLink.= "<li><a href='action.php?page_id=".$i."'>$i</a></li>";
                        $last=$i;
                      }
                      else
                      {
