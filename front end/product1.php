<?php 
    ...
    $products_list=array();
    $products_list=getProducts($min,$max);
    
  	$rec=getNumberOfPages();
    $records=ceil($rec/$max);

    if($page_id<1 || $page_id>$records)
    {
      header("Location:product1.php?page_id=1");
    }
          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-pagination">
              <nav>
                ...
                <?php if($page_id==1):?>
                  <li>
                    <a href="product1.php?page_id=<?php echo $page_id?>" aria-label="Previous">
                ...
                <?php if($page_id!=1):?>
                  <li>
                    <a href="product1.php?page_id=<?php echo $page_id-1?>" aria-label="Previous">
                      <span aria-hidden="true">&laquo;</span>
                    </a>
                  </li>
                <?php endif;?>
                <?php 
                  for ($i=1; $i<=$records; $i++):
                  	if($i==$page_id){
                        $pageLink.= "<li class='active'><a href='product1.php?page_id=".$i."'>$i</a></li>";
                  	}
                  	else{
                  		$pageLink.= "<li><a href='product1.php?page_id=".$i."'>$i</a></li>";
                  	}
                  endfor;
                  echo $pageLink; 
                ?>
                <?php if($page_id==$records):?>
                  <li>
                    <a href="product1.php?page_id=<?php echo $records?>" aria-label="Next">
                ...
                <?php if($page_id!=$records):?>
                  <li>
                    <a href="product1.php?page_id=<?php echo $page_id+1?>" aria-label="Next">
                      <span aria-hidden="true">&raquo;</span>
                    </a>
                  </li>
                <?php endif;?>
